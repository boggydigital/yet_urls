...
type PlayOptions struct {
	...
	Appearance   struct {
		...
		ShowSubscription        any    `json:"show_subscription"`
		...
		AdvertSkinType          any    `json:"advert_skin_type"`
	...
	Limits  []struct {
		...
		FirstPeriodFreq  any    `json:"first_period_freq"`
		EndFirstPeriod   any    `json:"end_first_period"`
		SecondPeriodFreq any    `json:"second_period_freq"`
	} `json:"limits"`
	IsSpatial              bool   `json:"is_spatial"`
	Mobile                 bool   `json:"mobile"`
	AllowP2P               bool   `json:"allow_p2p"`
	RemoveUnseekableBlocks bool   `json:"remove_unseekable_blocks"`
	DrmToken               any    `json:"drm_token"`
	EffectiveVideo         string `json:"effective_video"`
	Cuepoints              []any  `json:"cuepoints"`
